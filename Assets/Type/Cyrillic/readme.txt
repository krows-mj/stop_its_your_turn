...
True Type Font: Cyrillic Pixel-7 version 1.0


EULA
-==-
The font Cyrillic Pixel-7 is freeware for home use only.


DESCRIPTION
-=========-
This is pixel font like old cyrillic style, but not the same.

Files in cyrillic_pixel-7.zip:
       	readme.txt     			this file;
        cyrillic_pixel-7.ttf    	regular font;
	cyrillic_pixel-7.fon   		font in windows "FON" format;
	cyrillic_pixel-7_screen.png	preview image.
